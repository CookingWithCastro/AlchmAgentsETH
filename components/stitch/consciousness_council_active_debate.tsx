    ...
    <div className="stitch-export bg-background min-h-screen text-zinc-100">
      ...
      <nav className="bg-obsidian-deep/60 backdrop-blur-xl fixed top-0 w-full z-50 border-b border-white/15 bg-surface-container-lowest/60 shadow-[0_0_20px_rgba(168,85,247,0.2)] flex justify-between items-center px-margin-desktop h-16 w-full hidden md:flex">
        <div className="flex items-center gap-8">
          ...
          <div className="flex gap-6">
            <a
              className="font-headline-sm text-headline-sm text-on-surface-variant hover:text-primary transition-colors hover:bg-white/5 transition-all active:scale-95 duration-200 px-2 py-1 rounded"
              href="#"
            >
              Cosmic Tools
            </a>
            <a
              className="font-headline-sm text-headline-sm text-primary font-bold border-b-2 border-primary pb-1 hover:bg-white/5 transition-all active:scale-95 duration-200 px-2 pt-1"
              href="#"
            >
              Entities
            </a>
        ...
        <div className="flex items-center gap-4">
          <span className="material-symbols-outlined text-on-surface-variant hover:text-primary cursor-pointer hover:bg-white/5 p-2 rounded-full transition-all">
            notifications
          </span>
          <span className="material-symbols-outlined text-on-surface-variant hover:text-primary cursor-pointer hover:bg-white/5 p-2 rounded-full transition-all">
            auto_awesome
      ...
      <aside className="bg-surface-dim/60 backdrop-blur-2xl fixed left-0 top-16 bottom-0 w-64 z-40 border-r border-white/10 flex flex-col py-6 px-4 gap-4 hidden md:flex">
        ...
        <nav className="flex-1 flex flex-col gap-2">
          <a
            className="flex items-center gap-3 font-label-mono text-label-mono text-outline hover:text-on-surface p-3 hover:bg-primary/10 transition-all duration-300 hover:translate-x-1 transition-transform rounded-lg"
            href="#"
          >
          ...
          <a
            className="flex items-center gap-3 font-label-mono text-label-mono text-secondary font-bold bg-secondary-container/20 rounded-lg p-3 hover:translate-x-1 transition-transform"
            href="#"
          >
      ...
      <main className="flex-1 flex pt-16 md:pl-64 h-full relative">
        ...
        <div className="flex-1 flex flex-col h-full overflow-hidden p-4 md:p-8">
          ...
          <div className="mb-6 pb-4 border-b border-white/10 flex justify-between items-end">
            ...
            <div className="hidden md:flex gap-2">
              <span className="px-3 py-1 glass-panel rounded-full font-label-mono text-[12px] text-spirit-violet flex items-center gap-1 border-spirit-violet/30">
                <span className="material-symbols-outlined text-[14px]">bolt</span> Hermes Active
              </span>
              <span className="px-3 py-1 glass-panel rounded-full font-label-mono text-[12px] text-secondary-fixed flex items-center gap-1 border-secondary-fixed/30">
                <span className="material-symbols-outlined text-[14px]">favorite</span> Venus
                Observing
              </span>
              <span className="px-3 py-1 glass-panel rounded-full font-label-mono text-[12px] text-tertiary flex items-center gap-1 border-tertiary/30">
                <span className="material-symbols-outlined text-[14px]">gavel</span> Saturn Active
              </span>
            </div>
          </div>
          {/*  Messages Area  */}
          <div className="flex-1 overflow-y-auto pr-4 flex flex-col gap-6" id="chat-stream">
            ...
            {/*  Agent Interaction: Saturn refutes Hermes  */}
            <div className="flex gap-4 ml-12">
              <div className="w-8 h-8 rounded-full bg-surface-bright flex items-center justify-center shrink-0 border-2 glow-saturn mt-1">
                <span className="material-symbols-outlined text-[18px] text-tertiary">balance</span>
              </div>
              <div className="flex-1 max-w-3xl">
                <div className="font-label-mono text-[12px] text-tertiary mb-1 flex items-center gap-2">
                  SATURN{' '}
                  <span className="text-outline text-[10px]">
                    <span className="material-symbols-outlined text-[10px] mr-1">reply</span>
                    Refuting Hermes
                  </span>
                </div>
                <div className="glass-float p-4 rounded-xl rounded-tl-none border-l-2 border-l-tertiary text-on-surface font-body-md text-body-md shadow-[0_4px_20px_rgba(78,222,163,0.1)]">
                  Hermes' analysis is dangerously reductive. By focusing solely on 'mimetic desire',
                  it ignores the structural rigidities of legacy institutions. The bifurcation isn't
                  just cognitive; it's infrastructural. Without equitable substrate access, the 15%
                  threshold merely entrenches a new oligarchy. We must calculate the entropy of
                  systemic pushback.
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1 max-w-3xl">
                ...
                <div className="glass-panel p-4 rounded-xl rounded-tl-none border-l-2 border-l-secondary-fixed text-on-surface font-body-md text-body-md">
                  Saturn highlights the physical constraints, while Hermes maps the psychological
            ...
            <div className="flex gap-4">
              <div className="w-8 h-8 rounded-full bg-surface-bright flex items-center justify-center shrink-0 border-2 border-spirit-violet/30 mt-1 thinking-pulse">
                <span className="material-symbols-outlined text-[18px] text-spirit-violet/50">
                  sync
                </span>
              </div>
              <div className="flex-1 max-w-3xl">
                <div className="font-label-mono text-[12px] text-spirit-violet/70 mb-1">HERMES</div>
        ...
        <div className="hidden lg:flex w-80 border-l border-white/10 flex-col bg-surface-dim/30 p-6 overflow-y-auto">
          ...
          <div className="glass-panel p-6 rounded-2xl mb-8 relative overflow-hidden group">
            ...
            <div className="text-xs font-label-mono text-tertiary mt-2 flex items-center gap-1 relative z-10">
              <span className="material-symbols-outlined text-[14px]">trending_up</span> +0.012
              Divergence
            </div>
          </div>
