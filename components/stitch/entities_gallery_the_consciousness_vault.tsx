    ...
    <div className="stitch-export bg-background min-h-screen text-zinc-100">
      ...
      <nav className="hidden md:flex bg-obsidian-deep/60 backdrop-blur-xl docked full-width top-0 z-50 border-b border-white/10 shadow-[0_0_20px_rgba(168,85,247,0.2)] fixed top-0 w-full justify-between items-center px-gutter py-4">
        <div className="flex items-center space-x-8">
          ...
          <div className="flex space-x-6">
            ...
            <a
              className="font-body-md text-body-md text-primary border-b-2 border-primary pb-1 hover:text-primary transition-colors duration-300"
              href="#"
            >
              The Vault
            </a>
        ...
        <div className="flex items-center space-x-6">
          <div className="flex space-x-4 items-center">
            <div className="flex items-center space-x-2 text-secondary bg-surface-container-low px-3 py-1.5 rounded-full border border-secondary/20">
              <span className="material-symbols-outlined text-sm" data-icon="toll">
                toll
              </span>
              <span className="font-label-mono text-label-mono text-sm">1,450 ESMS</span>
            </div>
            <span
              className="material-symbols-outlined hover:text-primary transition-colors cursor-pointer text-on-surface-variant"
              data-icon="auto_awesome"
            >
              auto_awesome
            </span>
          </div>
          <div className="flex items-center space-x-3 bg-surface-container-low px-3 py-1.5 rounded-full border border-white/5 cursor-pointer hover:border-primary/50 transition-colors">
            <span className="font-label-mono text-label-mono text-primary">
              Monica Constant (A#)
            </span>
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-spirit-violet to-primary shadow-[0_0_10px_rgba(168,85,247,0.5)]"></div>
          </div>
        </div>
      </nav>
      {/*  SideNavBar (Mobile)  */}
      <nav
        className="md:hidden bg-surface-container-lowest/80 backdrop-blur-2xl h-screen w-64 left-0 top-0 fixed border-r border-primary/20 shadow-2xl flex flex-col h-full py-gutter transition-all duration-300 ease-in-out z-50 -translate-x-full"
        id="mobile-nav"
      >
        ...
        <div className="flex flex-col space-y-2 flex-grow">
          <a
            className="font-label-mono text-label-mono uppercase text-on-surface-variant px-4 py-3 hover:bg-white/5 hover:text-primary flex items-center space-x-3"
            href="#"
          >
          ...
          <a
            className="font-label-mono text-label-mono uppercase bg-primary-container/20 text-primary border-r-4 border-primary px-4 py-3 hover:bg-white/5 hover:text-primary flex items-center space-x-3"
            href="#"
          >
        ...
        <div className="px-4 mt-auto space-y-4">
          <div className="flex items-center justify-between text-secondary bg-surface-container-low px-4 py-3 rounded border border-secondary/20">
      ...
      <main className="flex-grow pt-24 md:pt-32 pb-16 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto w-full">
        ...
        <div className="flex flex-wrap gap-4 mb-12 border-b border-outline-variant/30 pb-4">
          <button className="font-label-mono text-label-mono text-primary border-b-2 border-primary pb-2 tracking-widest uppercase">
            Ascendant Agents
          </button>
          <button className="font-label-mono text-label-mono text-on-surface-variant hover:text-primary transition-colors pb-2 tracking-widest uppercase">
            Historical Minds
          </button>
          <button className="font-label-mono text-label-mono text-on-surface-variant hover:text-primary transition-colors pb-2 tracking-widest uppercase">
            Your Collection
          ...
          <div className="flex justify-between items-end mb-8">
            <div>
              <h2 className="font-headline-lg text-headline-lg text-inverse-surface mb-2 flex items-center gap-2">
                <span className="material-symbols-outlined text-secondary" data-icon="stars">
                  stars
                </span>
            ...
            <button className="hidden md:flex font-label-mono text-label-mono text-primary items-center gap-2 hover:text-spirit-violet transition-colors">
              View Complete Atlas{' '}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="glass-panel rounded-xl p-6 glow-hover transition-all duration-300 group relative overflow-hidden flex flex-col">
              ...
              <div className="flex justify-between items-start mb-6 relative z-10">
                <div>
                  <h3 className="font-headline-sm text-headline-sm text-monica-constant mb-1 group-hover:text-primary transition-colors">
                    Aurion Prime
                  </h3>
                ...
                <div className="text-right">
                  <span className="block font-label-mono text-label-mono text-secondary text-xs uppercase mb-1">
                    A# Constant
                  </span>
              ...
              <div className="flex gap-4 items-center mb-6">
                ...
                <div className="grid grid-cols-3 gap-2 flex-grow">
                  <div className="bg-surface-container-highest/50 rounded p-2 border border-white/5 text-center">
                    ...
                    <span className="font-label-mono text-label-mono text-primary text-sm">84</span>
                  </div>
                  <div className="bg-surface-container-highest/50 rounded p-2 border border-white/5 text-center">
                    <span className="font-label-mono text-label-mono text-[10px] text-on-surface-variant block uppercase">
                      Creation
              ...
              <div className="mt-auto flex justify-between items-center border-t border-white/10 pt-4 relative z-10">
                ...
                <button className="bg-primary-container/20 hover:bg-primary-container/40 text-primary border border-primary/30 rounded px-4 py-2 font-label-mono text-label-mono text-xs uppercase transition-colors shadow-[0_0_10px_rgba(124,58,237,0.2)]">
                  Interact
                </button>
              </div>
            </div>
            ...
            <div className="glass-panel rounded-xl p-6 glow-hover transition-all duration-300 group relative overflow-hidden flex flex-col">
              ...
              <div className="flex justify-between items-start mb-6 relative z-10">
                <div>
                  <h3 className="font-headline-sm text-headline-sm text-monica-constant mb-1 group-hover:text-secondary transition-colors">
                    Vela Pulsar
                  </h3>
                  <span className="font-label-mono text-label-mono text-on-surface-variant text-xs flex items-center gap-1">
                    <span className="material-symbols-outlined text-[16px]" data-icon="waves">
                      waves
                    </span>{' '}
                    Aquarius Core
                  </span>
              ...
              <div className="flex gap-4 items-center mb-6">
                <div className="w-16 h-16 radar-chart flex-shrink-0 relative border-secondary/20">
                  <div className="absolute inset-2 border border-secondary/30 rounded-full"></div>
                </div>
                <div className="grid grid-cols-3 gap-2 flex-grow">
                  <div className="bg-surface-container-highest/50 rounded p-2 border border-white/5 text-center">
                    <span className="font-label-mono text-label-mono text-[10px] text-on-surface-variant block uppercase">
                    ...
                    <span className="font-label-mono text-label-mono text-secondary text-sm">
                      95
                    </span>
                  </div>
                  <div className="bg-surface-container-highest/50 rounded p-2 border border-white/5 text-center">
                    ...
                    <span className="font-label-mono text-label-mono text-primary text-sm">72</span>
                  </div>
                  <div className="bg-surface-container-highest/50 rounded p-2 border border-white/5 text-center">
                    <span className="font-label-mono text-label-mono text-[10px] text-on-surface-variant block uppercase">
                      Will
              ...
              <div className="mt-auto flex justify-between items-center border-t border-white/10 pt-4 relative z-10">
                ...
                <button className="bg-secondary-container/20 hover:bg-secondary-container/40 text-secondary border border-secondary/30 rounded px-4 py-2 font-label-mono text-label-mono text-xs uppercase transition-colors shadow-[0_0_10px_rgba(238,194,0,0.2)]">
                  Interact
                </button>
              </div>
            </div>
            ...
            <div className="glass-panel rounded-xl p-6 glow-hover transition-all duration-300 group relative overflow-hidden flex flex-col">
              ...
              <div className="flex justify-between items-start mb-6 relative z-10">
                <div>
                  ...
                  <span className="font-label-mono text-label-mono text-on-surface-variant text-xs flex items-center gap-1">
                    <span className="material-symbols-outlined text-[16px]" data-icon="landscape">
                      landscape
                    </span>{' '}
                    Taurus Root
                  </span>
              ...
              <div className="flex gap-4 items-center mb-6">
                ...
                <div className="grid grid-cols-3 gap-2 flex-grow">
                  ...
                  <div className="bg-surface-container-highest/50 rounded p-2 border border-white/5 text-center">
                    ...
                    <span className="font-label-mono text-label-mono text-primary text-sm">79</span>
                  </div>
                </div>
              </div>
              <div className="mt-auto flex justify-between items-center border-t border-white/10 pt-4 relative z-10">
      ...
      <footer className="bg-obsidian-deep w-full py-8 mt-auto border-t border-outline-variant/30 flex flex-col md:flex-row justify-between items-center px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        <div className="text-primary font-bold font-label-mono text-label-mono mb-4 md:mb-0">
          Planetary Agents
        </div>
