  ...
  return (
    <div className="stitch-export bg-background min-h-screen text-zinc-100">
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden flex items-center justify-center">
        ...
        <div className="absolute w-[600px] h-[600px] bg-primary/5 rounded-full blur-[80px] opacity-30 mix-blend-screen animate-pulse-glow"></div>
      </div>
      <main className="flex-grow flex flex-col items-center justify-center p-gutter relative z-10 w-full max-w-container-max mx-auto">
        <header className="text-center mb-16 space-y-4">
          ...
          <h1 className="font-headline-xl text-headline-xl text-primary drop-shadow-[0_0_15px_rgba(210,187,255,0.3)]">
            Infuse Knowledge
          </h1>
        ...
        <div className="relative flex flex-col items-center justify-center w-full max-w-2xl mb-12">
          ...
          >
            ...
            <div className="absolute inset-4 rounded-full border border-primary/20 animate-spin-slow-reverse"></div>
            <div className="absolute inset-12 rounded-full border-2 border-spirit-violet/10"></div>
            <div className="absolute inset-16 rounded-full bg-surface-container-lowest/60 backdrop-blur-2xl border border-primary/30 shadow-[0_0_50px_rgba(168,85,247,0.15)] group-hover:shadow-[0_0_80px_rgba(168,85,247,0.3)] transition-all duration-500 flex flex-col items-center justify-center text-center p-6 z-20">
              <span className="material-symbols-outlined text-5xl text-primary mb-4 group-hover:text-spirit-violet transition-colors duration-300 drop-shadow-[0_0_10px_rgba(210,187,255,0.5)]">
                magic_button
              </span>
              <p className="font-label-mono text-label-mono text-primary uppercase tracking-wider group-hover:text-white transition-colors duration-300">
                Drop Tomes Here
              </p>
          ...
          <div className="mt-12 w-full max-w-md relative z-20">
            <div className="relative group">
              ...
              <input
                ...
                type="text"
              />
              <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-transparent text-primary hover:text-spirit-violet p-2 transition-colors">
        ...
        <div className="w-full max-w-3xl flex flex-col items-center z-20">
          ...
          <div className="flex flex-wrap justify-center gap-4 w-full" id="sigil-container">
            <div className="flex items-center gap-3 bg-surface-container-high/60 backdrop-blur-md border border-primary/20 rounded-full pl-2 pr-4 py-2 shadow-[0_0_15px_rgba(168,85,247,0.05)] hover:border-spirit-violet/50 transition-colors group">
              <div className="w-8 h-8 rounded-full bg-surface-dim flex items-center justify-center border border-primary/10 group-hover:border-primary/40 transition-colors">
                <span className="material-symbols-outlined text-sm text-primary">description</span>
              </div>
              <span className="font-label-mono text-sm text-on-surface-variant group-hover:text-primary transition-colors">
        ...
        <div className="fixed bottom-0 left-0 w-full p-6 flex justify-between items-center z-30 pointer-events-none">
          ...
          <button className="pointer-events-auto px-8 py-3 bg-spirit-violet text-white font-label-mono text-label-mono uppercase shadow-[0_0_20px_rgba(168,85,247,0.4)] hover:shadow-[0_0_30px_rgba(255,255,255,0.6)] hover:bg-primary transition-all duration-300 rounded flex items-center gap-2">
            Commence Synthesis
