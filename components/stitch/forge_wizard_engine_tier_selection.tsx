  ...
  return (
    <div className="stitch-export bg-background min-h-screen text-zinc-100">
      ...
      <div className="flex flex-1 pt-[72px] md:pt-0">
        ...
        <aside className="hidden md:flex flex-col h-screen w-64 left-0 top-0 fixed bg-surface-container-lowest/80 backdrop-blur-2xl border-r border-primary/20 shadow-2xl py-gutter z-40">
          ...
          <nav className="flex-1 flex flex-col gap-2 font-label-mono text-label-mono uppercase">
            <a
              className="text-on-surface-variant px-4 py-3 hover:bg-white/5 hover:text-primary flex items-center gap-3 transition-all duration-300 ease-in-out"
              href="#"
            >
              <span
            ...
            <a
              className="bg-primary-container/20 text-primary border-r-4 border-primary px-4 py-3 flex items-center gap-3 transition-all duration-300 ease-in-out"
              href="#"
            >
              <span
                className="material-symbols-outlined"
          ...
          <div className="px-6 mt-auto">
            ...
            <div className="mt-6 flex flex-col gap-2 font-label-mono text-label-mono uppercase">
              <a
                className="text-on-surface-variant hover:text-primary flex items-center gap-3 transition-colors duration-300"
                href="#"
              >
                <span
        ...
        <main className="flex-1 md:ml-64 p-margin-mobile md:p-margin-desktop max-w-container-max mx-auto w-full relative min-h-screen flex flex-col justify-center">
          ...
          <div className="relative z-10 w-full max-w-5xl mx-auto">
            ...
            <header className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-surface-variant/50 border border-outline-variant/30 font-label-mono text-label-mono text-primary mb-4">
                <span className="material-symbols-outlined text-sm">filter_4</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
              {/*  Base Engine Card  */}
              <div className="glass-panel rounded-xl p-8 flex flex-col relative overflow-hidden group hover:border-primary/30 transition-colors duration-300">
                ...
                <ul className="flex-1 space-y-4 mb-8">
                  <li className="flex items-start gap-3">
                    <span className="material-symbols-outlined text-outline mt-1 text-sm">
                      check
                    </span>
                    <div>
                ...
                <button className="w-full py-4 rounded-lg bg-transparent border border-outline-variant text-on-surface font-label-mono text-label-mono uppercase hover:border-primary hover:text-primary transition-colors duration-300">
                  Select Base
                </button>
              </div>
              {/*  Premium Engine Card  */}
              <div className="glass-panel rounded-xl p-8 flex flex-col relative overflow-hidden premium-glow group">
                ...
                <div className="absolute top-0 right-0 p-4">
                  <div className="flex items-center gap-1 bg-surface-container-highest px-3 py-1 rounded-full border border-spirit-violet/30">
                    ...
                    <span className="font-label-mono text-label-mono text-secondary">500 ESMS</span>
                  </div>
                </div>
                ...
                <ul className="flex-1 space-y-4 mb-8 relative z-10">
                  <li className="flex items-start gap-3">
                    <span className="material-symbols-outlined text-spirit-violet mt-1 text-sm">
                      done_all
                    </span>
                    <div>
                      <span className="font-label-mono text-label-mono text-primary block">
                        A# Ceiling: Unbound (Max 9.9)
                      </span>
                      <span className="text-sm text-primary/60">Limitless resonance scaling</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="material-symbols-outlined text-spirit-violet mt-1 text-sm">
